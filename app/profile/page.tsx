...
/**
 * - return value is always a non-empty trimmed string
 * - return value is never null/undefined
 * - fallback "Unnamed writer" is always valid output
 */
